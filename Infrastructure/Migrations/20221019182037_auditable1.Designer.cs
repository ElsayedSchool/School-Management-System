...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20221019182037_auditable1")]
    partial class auditable1
    {
            ...
            modelBuilder.Entity("Domain.Entities.Branch", b =>
                {
                    ...
                    b.HasIndex("BranchId", "BranchName")
                        .IsUnique();
            ...
            modelBuilder.Entity("Domain.Entities.UserProfile", b =>
                {
                    ...
                    b.Property<DateTime?>("HireDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 10, 19, 20, 20, 37, 24, DateTimeKind.Local).AddTicks(3147));
            ...
            modelBuilder.Entity("Domain.Entities.Exam", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Session", "Session")
                        .WithOne("Exam")
                        .HasForeignKey("Domain.Entities.Exam", "SessionId");
